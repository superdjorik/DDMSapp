...
source.exclude_dirs = test, bin, venv, .idea
...
android.permissions = android.permission.INTERNET, android.permission.SERIAL, android.permission.WRITE_EXTERNAL_STORAGE, android.permission.READ_EXTERNAL_STORAGE
